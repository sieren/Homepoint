...
cd M5Stack
python ../merge_bin_esp.py --output_name homepoint_m5stack.bin --bin_path partition-table.bin bootloader.bin homepoint.bin spiffs.bin --bin_address 0x8000 0x1000 0x10000 0x360000
cd ..
mkdir release
...
cd ESP32
python ../merge_bin_esp.py --output_name homepoint_espgeneric.bin --bin_path partition-table.bin bootloader.bin homepoint.bin spiffs.bin --bin_address 0x8000 0x1000 0x10000 0x360000
cd ..
mkdir release

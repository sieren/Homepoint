...
#define LV_FONT_DEFAULT         LV_FONT_DECLARE(robotocondensed_regular_12_nokern) //&lv_font_montserrat_16
#else
...
#define LV_THEME_DEFAULT_INIT               lv_theme_mono_init // We init the theme ourselves

...
void* TFT_eSprite::createSprite(int16_t w, int16_t h, uint8_t frames)
{
  ...
  Serial.println("didnt return NULL");
...
#endif
Serial.println("Tried to alloc ptr8 with 16");
  ...
  else if (_bpp == 8)
  {
    ...
    Serial.println("Tried to alloc ptr8");
  }
...
#endif
Serial.println("Tried to alloc ptr8 1bpp");
